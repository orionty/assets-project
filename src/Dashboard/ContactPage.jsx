...
const sendMail = () =>{
    Axios.post("https://assets-vaults.herokuapp.com/mail",{
        firstname: firstname,
        lastname: lastname,
        email: email,
        message:message
  ...
  return (
    ...
    <img src="img/AV.ico" alt="assets-icon" width="100" height="80"  className='rounded-3 mb-3' /> </a>
  </div>
   <div>
    ...
    <p class="text-center w-responsive mx-auto mb-5 pt-5" style={{color:"navy"}}>Do you have any questions? Please do not hesitate to contact us directly. Our team will come back to you within
        ...
        <form class="row g-3 needs-validation" novalidate>
          ...
          <div class="col-12 mb-5">
            <button class="btn "  style={{backgroundColor:"#0b939b",color:"white"}} onClick={sendMail}>Submit form</button>
          </div>
        </form>
