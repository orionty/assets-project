...
function ForgotPassword() {
  ...
  return (
    <div>
          ...
          <NavBar />
   <Card>
   <Card.Img src="/img/signInBg.jpg" className="form-image-bg" alt="giving-image" />
  ...
  <label class="form-check-label" for="flexSwitchCheckDefault">Remember me</label>
         ...
         <Link to ="/sign-in" className="text-decoration-none text-light"><p className='text-center mt-2' style={{cursor:"pointer"}}><FaArrowLeft /> Sign In</p></Link>
        </div>
   </Card.ImgOverlay>
